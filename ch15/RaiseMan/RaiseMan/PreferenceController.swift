...
class PreferenceController: NSWindowController {
    ...
    static let BNRColorChangedNotification = "BNRColorChanged"
    ...
    @IBAction func changeBackgroundColor(_ sender : Any) {
        ...
        let d = ["color" : color]
        //NotificationCenter.default.post(name: NSNotification.Name(rawValue: PreferenceController.BNRColorChangedNotification), object: color)
        NotificationCenter.default.post(name: NSNotification.Name(rawValue:PreferenceController.BNRColorChangedNotification),
                                        object: self,
                                        userInfo: d)
